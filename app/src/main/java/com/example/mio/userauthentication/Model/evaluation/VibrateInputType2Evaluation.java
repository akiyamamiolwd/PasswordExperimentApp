...
public class VibrateInputType2Evaluation {
    ...
    public VibrateInputType2Evaluation(){
    }

    public VibrateInputType2Evaluation(int testGroupNum, int passwordLen, int hintType){
